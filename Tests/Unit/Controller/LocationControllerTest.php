<?php
namespace Visol\EasyvoteLocation\Tests\Unit\Controller;
/***************************************************************
 *  Copyright notice
 *
...
/**
 * Test case for class Visol\EasyvoteLocation\Controller\LocationController.
 *
...
class LocationControllerTest extends \TYPO3\CMS\Core\Tests\UnitTestCase {
	...
	/**
	 * @var \Visol\EasyvoteLocation\Controller\LocationController
	 */
	protected $subject = NULL;

	protected function setUp() {
		$this->subject = $this->getMock('Visol\\EasyvoteLocation\\Controller\\LocationController', array('redirect', 'forward', 'addFlashMessage'), array(), '', FALSE);
	}
	...
	public function listActionFetchesAllLocationsFromRepositoryAndAssignsThemToView() {
		...
		$locationRepository = $this->getMock('Visol\\EasyvoteLocation\\Domain\\Repository\\LocationRepository', array('findAll'), array(), '', FALSE);
